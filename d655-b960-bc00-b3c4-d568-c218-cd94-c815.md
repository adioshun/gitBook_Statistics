...
3. 알수 있는 정보를 이용하기 위해 사후확률 --> 사전확률$$p(\omega_i)$$와 우도$$p(X \mid \omega_i)$$의 곱으로 대치 
...
- 모멘트법 (Method of Moment) [[참고자료]](http://www.kim2kie.com/cafeUpload/Databoard/files/208_moment&mle.pdf)

- 최우도법 (Maximum likelihood method)
